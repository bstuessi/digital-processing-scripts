select * 
from files
where digital_media_id = 'D_0210'
and format_id = 7;

select count(*)
from files
where digital_media_id = 'D_0210'
and appraisal = 'duplicate';
...
WHERE
    d1.digital_media_id = 'D_0210'
    and d2.digital_media_id = 'D_0210'-- Replace 'your_media_id' with the desired media_id
    AND d1.id != d2.id
--	and m.group_id = '1.1'
...
WHERE
    f1.digital_media_id = 'D_0210'
    and f2.digital_media_id = 'D_0210'-- Replace 'your_media_id' with the desired media_id
    AND f1.id != f2.id
--	and m.group_id = '1.1'
